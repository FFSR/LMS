...
public class Section {
	...
	@RequestMapping(value="/getDeptwiseSectionData/{deptid}", method=RequestMethod.GET)
	public ResponseEntity<List<LmsSection>> getDeptwiseSectionData(@PathVariable("deptid") int deptid) {
		
		List<LmsSection> listLmssection = new ArrayList<>();
		
		try {
			listLmssection = LmsSectionHome.getDeptwiseSection(deptid);
