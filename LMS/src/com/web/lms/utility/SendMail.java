...
public class SendMail {
	...
	public static void SendMailForRegistration(String emailid,String name,String flag){  
	   ...
	   public static void SendMailForPassword(String emailid,String passwd){  
		final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
		  // Get a Properties object
		     Properties props = System.getProperties();
		     props.setProperty("mail.smtp.host", "smtp.gmail.com");
		  ...
		  // -- Set the FROM and TO fields --
		     ...
		     msg.setText("Dear Sir, Your password is :" + passwd);
	   ...
	   public String SendMailForValidation(String emailid,String passwd){  
			final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
			  // Get a Properties object
			     Properties props = System.getProperties();
			     props.setProperty("mail.smtp.host", "smtp.gmail.com");
