...
<link href="resources/bootstrap/dist/css/bootstrap.min.css"
	rel="stylesheet">
<link
	href="resources/bower_components/bootstrap-extension/css/bootstrap-extension.css"
	rel="stylesheet">
<!-- Menu CSS -->
<link
	href="resources/bower_components/sidebar-nav/dist/sidebar-nav.min.css"
	rel="stylesheet">
<!-- toast CSS -->
<link
	href="resources/bower_components/toast-master/css/jquery.toast.css"
	rel="stylesheet">
<!-- morris CSS -->
...
<body ng-app="myApp">
	...
	<div id="wrapper">
			...
			<div class="navbar-header">
				...
				<div class="top-left-part">
					<a class="logo" href="index.html"><b>
							...
							<img src="resources/images/eliteadmin-logo.png" alt="home"
							class="dark-logo" />
						<!--This is light logo icon-->
							<img src="resources/images/eliteadmin-logo-dark.png" alt="home"
							class="light-logo" />
					</b><span class="hidden-xs">
							<!--This is dark logo text-->
							<img src="resources/images/eliteadmin-text.png" alt="home"
							class="dark-logo" />
						<!--This is light logo text-->
							<img src="resources/images/eliteadmin-text-dark.png" alt="home"
							class="light-logo" />
					</span></a>
				</div>
			...
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<div class="user-profile">
					<div class="dropdown user-pro-body">
						<div>
							<img src="resources/images/users/varun.jpg" alt="user-img"
								class="img-circle">
						</div>
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="employeehomepage" class="waves-effect"><i
							data-icon="v" class="linea-icon linea-basic fa-fw"></i><span
							class="hide-menu">Home</span></a></li>
					<li><a href="javascript:void(0);" class="waves-effect"><i
							class="linea-icon linea-basic fa-fw text-danger" data-icon="7"></i>
							<span class="hide-menu text-danger"> Leave Management <span
					...
					<li><a href="leavehistory" class="waves-effect"><i
							data-icon="v" class="linea-icon linea-basic fa-fw"></i><span
							class="hide-menu">My Leave Balance</span></a></li>
					<li><a href="rptleavestatus" class="waves-effect"><i
							data-icon="v" class="linea-icon linea-basic fa-fw"></i><span
							class="hide-menu">My Leave Status</span></a></li>

					<li><a href="#" class="waves-effect"><i data-icon=")"
							class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Reports<span
								class="fa arrow"></span></span></a>
						<ul class="nav nav-second-level">
					...
					<li><a href="#" class="waves-effect"><i data-icon="/"
							class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Maintenance<span
								class="fa arrow"></span></span></a>
						<ul class="nav nav-second-level">
		...
		<div id="page-wrapper">
			...
			<!-- /.container-fluid -->
			<footer class="footer text-center"> 2018 &copy; Leave
				Management System </footer>
		</div>
		<!-- /#page-wrapper -->
	</div>
	<!-- /#wrapper -->
