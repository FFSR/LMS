...
<link rel="icon" type="image/png" sizes="16x16"
	href="resources/images/govt.jpg">
			...
			<div class="navbar-header">
				...
				<div class="top-left-part">
					<a class="logo" href="index.html"><b>
							...
							<img src="resources/images/eliteadmin-log2o.png" alt="home"
							class="dark-logo" />
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#" class="waves-effect"><i data-icon="/"
							class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Maintainance<span
								class="fa arrow"></span></span></a>
						<ul class="nav nav-second-level">
