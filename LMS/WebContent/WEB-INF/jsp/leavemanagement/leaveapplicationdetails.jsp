			...
			<div class="form-body">
					...
					<form role="form">
						<div class="row">
							<button type="submit"
								...
								id="search"
								ng-click="loadDatewiserptleavestatus('${sessionScope.user.id}')"
								ng-disabled="rptleavestatusForm.$invalid">Search</button>
				...
				<div class="container-fluid">
					...
					<div ng-if="showLeaveDetails">
						...
						<h2 style="font-family: Arial; color: #000; font-size: 20px; font-wight: bold; ">This is a system generated document. It does not need any
							signature.</h2>
					</div>
