...
<div class="container-fluid">
		...
		<div class="row">
			<div class="col-sm-3" style="background-color: lavender;">Start Date</div>
			<div class="col-sm-3" style="background-color: lavenderblush;">
				<input type="text">
			</div>
			<div class="col-sm-3" style="background-color: lavender;">End Date</div>
			<div class="col-sm-3" style="background-color: lavenderblush;">
				<input type="text">
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-3" style="background-color: lavender;">Employee ID</div>
			<div class="col-sm-3" style="background-color: lavenderblush;">
				<input type="text">
			</div>		
		</div>
