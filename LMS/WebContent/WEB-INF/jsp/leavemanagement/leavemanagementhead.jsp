				...
				<div>
					...
					<table ng-table="tableParams" class="table" show-filter="true">
						<tr ng-repeat="leaveapplication in $data">
							<td title="'Leave ID'" filter="{ name: 'text'}"
								sortable="'name'">{{leaveapplication.id}}</td>
							...
							<td title="'Leave Type'" filter="{ leavetaken: 'text'}"
								sortable="'takenleave'">{{leaveapplication.lmsLeaveType.type}}</td>
							...
							<td title="'Action'"><button class="btn-primary" ng-click="showLeaveApplicationDetails(leaveapplication)">Details</button></td>
					</table>
				</div>
			</table>
		</div>
...
<div class="container-fluid">
	<div ng-if="showLeaveDetails">
			<div class="row">
				...
				<div class="col-sm-3" style="background-color: white;"><input type="text" ng-model="leaveapplication.lmsUserByUserId.name"></div>
			...
			<div class="row">
				...
				<div class="col-sm-3" style="background-color: white;">Leave Type</div>
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.lmsLeaveType.type" class="form-control" placeholder="type">
				</div> 
				<div class="col-sm-3" style="background-color: white;">Reason For Leave</div>
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.reasonForLeave" class="form-control" placeholder="reasonForLeave">
				</div> 
			</div>
			<br>
			...
			<div class="row">
				...
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.eligibility" class="form-control" placeholder="eligibility">
				</div> 
				<div class="col-sm-3" style="background-color: white;">Leave Allready Taken</div>
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.leaveTaken" class="form-control" placeholder="leaveTaken">
				</div> 
			</div>
			<br>
			...
			<div class="row">
				...
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.leaveBalance" class="form-control" placeholder="leaveBalance">
				</div> 
			...
			<div class="row">				
				...
				<div class="col-sm-3" style="background-color: white;">From Date</div>
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.fromDate.toString()" class="form-control" placeholder="fromDate">
				</div>
				<div class="col-sm-3" style="background-color: white;">To Date</div>
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.toDate.toString()" class="form-control" placeholder="Fax">
				</div> 
			</div>
			<br><br>
			<div class="row">
				...
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.totalDayCount" class="form-control" placeholder="totalDayCount">
				</div>
				
				<div class="col-sm-3" style="background-color: white;">Task Need to be Performed</div>
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.taskNeedToPerformed" class="form-control" placeholder="Fax">
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-3" style="background-color: white;">Reliever Email Address</div>
				<div class="col-sm-3" style="background-color: white;">
				<input type="text" ng-model="leaveapplication.lmsUserByUserId.email" class="form-control" placeholder="Fax">
				</div>
		   ...
		   <div class="dropdown"> <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Status
           ...
           <li><a href="#">Reject</a></li>
			...
			<div class="row">
				...
				<button type="submit" class="btn" id="submit"
					ng-click="userleave()">Update</button>
			</div>
	</div>
</div>
