...
<title>Insert title here</title>
	<!-- Created By Feroj 14th June 2018 
	Revision history:
...
<script type="text/javascript"
	src="resources/js/app.js/controller/leavecancelController.js"></script>
	...
	<div ng-controller="leavecancelController">
		...
		<form class="form-horizontal" name="leavecancelForm">
			<div class="form-body">
				...
				<h2 style="font-family: Arial; color: #000; font-size: 20px; font-wight: bold; ">Leave Information</h2>
		<div class="container-fluid">
			<div ng-show="showLeaveDetails">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" ng-disabled="true"
									ng-model="wfRequestHop.lmsUserByUserId.id"
									class="form-control">
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" ng-disabled="true"
									ng-model="wfRequestHop.lmsLeaveApplication.reasonForLeave"
									class="form-control">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-md-3">Cancel Reason</label>
							<div class="col-md-9">
								<input type="text" ng-disabled="false"
									ng-model="CancelReason"
									class="form-control">
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="EndDate" ng-model="EndDate"
									class="form-control" />
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-md-3">Days of Adjustment</label>
							<div class="col-md-9">
								<input type="text" ng-disabled="false"
									ng-model="AdjustDays"
									class="form-control">
				...
				<div class="row">
					<div class="col-sm-4">
						<button type="submit" class="btn btn-primary" id="btnValidate"
							ng-click="validate()" ng-disabled="leavecancelForm.$invalid">Validate</button>
					</div>
					<div class="col-sm-4">
						<button type="submit" class="btn btn-danger" id="submit"
							ng-click="cancelLeave()" ng-disabled="validationLock">Submit</button>
					</div>
					<div class="col-sm-4">
